  ...
  return (
    <section className="bg-surface-container-low py-24 md:py-32 px-6 md:px-8" id="demo">
      ...
      <div className="max-w-4xl mx-auto aspect-video bg-surface-container-lowest rounded-3xl overflow-hidden ambient-shadow flex items-center justify-center relative group">
        ...
        <div className="absolute inset-0 w-full h-full bg-gradient-to-br from-surface-container-low via-surface-container to-surface-container-high flex items-center justify-center">
          <span className="material-symbols-outlined text-6xl text-on-surface/20">play_circle</span>
        </div>

        {/* Play Button Overlay */}
        <button
          onClick={() => setIsPlaying(!isPlaying)}
          className="relative z-10 w-20 h-20 signature-gradient rounded-full flex items-center justify-center text-on-primary ambient-shadow scale-100 group-hover:scale-110 transition-transform duration-300"
